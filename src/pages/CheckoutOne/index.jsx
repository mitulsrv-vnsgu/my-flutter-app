          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="bg-gray_51 flex flex-col items-center justify-end p-[23px] sm:px-5 w-full">
              <div className="flex flex-col gap-9 items-center justify-start mb-2 mt-3.5 w-[99%] md:w-full">
                ...
                <div className="flex md:h-[777px] h-[802px] justify-end relative w-full">
                  ...
                  <div className="absolute bg-white_A700 flex flex-col md:gap-10 gap-[65px] h-full inset-[0] items-center justify-center m-auto p-[111px] md:px-10 sm:px-5 rounded shadow-bs w-full">
                    <Img
                      src="images/img_group18037.svg"
                      className="h-52"
                      alt="Group18037"
                    />
                    <div className="flex flex-col gap-8 items-center justify-start mb-[143px] w-[56%] md:w-full">
                      <div className="flex flex-col gap-2 justify-start w-full">
                        <Text
                          className="ml-12 md:ml-[0] text-bluegray_900"
                          as="h4"
                          size="3xl"
                        >
                        ...
                        <Text
                          className="!font-normal leading-[22.00px] text-bluegray_900 text-center w-full"
                          size="md"
                        >
                      ...
                      <Button className="bg-deep_orange_300 cursor-pointer font-bold min-w-[207px] py-[15px] rounded-[24px] text-center text-sm text-white_A700">
                        Review product
                      </Button>
                    </div>
                  </div>
