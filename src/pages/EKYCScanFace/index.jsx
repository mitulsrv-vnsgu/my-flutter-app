          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="bg-gray_51 flex flex-col items-center justify-end p-[23px] sm:px-5 w-full">
              <div className="flex flex-col gap-[35px] items-center justify-start mt-[15px] w-full">
                ...
                <div className="bg-white_A700 flex flex-col gap-10 items-center justify-start p-12 md:px-10 sm:px-5 rounded shadow-bs w-full">
                  <div className="flex flex-col gap-5 items-center justify-end p-1">
                  ...
                  <div className="flex flex-col relative w-[56%] sm:w-full">
                    <div className="h-[504px] mx-auto w-full">
                      ...
                      />
                      <div
                        className="absolute bg-cover bg-no-repeat md:h-[377px] h-[504px] inset-[0] justify-center m-auto p-[62px] md:px-10 sm:px-5 w-full"
                        style={{
                      ...
                      >
                        <Img
                          ...
                          className="absolute h-[377px] inset-[0] justify-center m-auto"
                          alt="Group One"
                        />
                      </div>
                    </div>
                    <div className="bg-deep_orange_300 h-20 md:h-[11px] mt-[-17px] mx-auto outline outline-[4px] outline-white_A700 p-[26px] sm:px-5 rounded-[50%] w-20 z-[1]">
                      <Img
