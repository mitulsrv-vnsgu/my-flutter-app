            ...
            <div className="bg-gray_51 flex flex-col items-center justify-end p-[23px] sm:px-5 w-full">
              <div className="flex flex-col gap-[35px] items-center justify-start mt-[15px] w-full">
                ...
                <div className="bg-white_A700 flex flex-col items-center justify-start p-12 md:px-10 sm:px-5 rounded shadow-bs w-full">
                  ...
                  <div className="bg-gray_51 border-2 border-dashed border-indigo_51 flex flex-col items-end justify-end mt-10 p-8 sm:px-5 rounded w-[65%] md:w-full">
                    <div className="flex flex-col gap-9 justify-start mt-[79px] w-[95%] md:w-full">
                      <Img
                        ...
                        alt="SignatureofKa"
                      />
                      <div className="flex flex-row gap-6 items-center justify-end md:ml-[0] ml-[451px] w-[23%] md:w-full">
                  ...
                  <Button className="bg-deep_orange_300 cursor-pointer font-bold min-w-[270px] mt-[50px] py-[15px] rounded-[24px] text-center text-sm text-white_A700">
                    Finish process
                  </Button>
                </div>
              </div>
