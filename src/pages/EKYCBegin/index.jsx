          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="bg-gray_51 flex flex-col items-center justify-end p-[23px] sm:px-5 w-full">
              <div className="flex flex-col gap-[35px] items-center justify-start mt-[15px] w-full">
                ...
                <div className="bg-white_A700 flex flex-col items-start justify-start p-[124px] md:px-10 sm:px-5 rounded shadow-bs w-full">
                  <div className="flex flex-col items-center justify-start mb-[118px] md:ml-[0] ml-[281px] w-[30%] md:w-full">
                    <Img
                    ...
                    <Button className="bg-deep_orange_300 cursor-pointer font-bold min-w-[162px] mt-6 py-[15px] rounded-[24px] text-center text-sm text-white_A700">
                      Verify now
                    </Button>
                  </div>
                </div>
