              ...
              <div className="flex flex-col gap-[38px] items-start justify-start mt-3.5 w-full">
                ...
                <div className="flex md:flex-col flex-row font-inter gap-5 items-center justify-between w-full">
                  <div className="bg-white_A700 flex md:flex-1 flex-col items-center justify-start p-8 sm:px-5 rounded shadow-bs w-[24%] md:w-full">
                    <div className="flex flex-col items-start justify-start mb-2 w-full">
                      <div className="flex flex-col gap-6 items-center justify-start w-full">
                        ...
                        <Button
                          className="bg-deep_orange_300 cursor-pointer flex items-center justify-center min-w-[209px] pl-[29px] py-[17px] rounded-[24px]"
                          rightIcon={
                            <Img
                              src="images/img_plus.svg"
                              className="ml-[5px] mr-[35px] my-3.5"
                              alt="plus"
                            />
                          }
                        >
                  ...
                  <div className="bg-white_A700 flex md:flex-1 flex-col items-center justify-start p-[26px] sm:px-5 rounded shadow-bs w-3/4 md:w-full">
                    <div className="flex flex-col gap-[30px] items-center justify-start mb-[3px] w-[99%] md:w-full">
                      <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between w-full">
                        <div className="flex sm:flex-1 flex-row gap-[34px] items-end justify-between w-[42%] sm:w-full">
                          <Text
                            className="mb-1 mt-2.5 text-bluegray_900"
                            as="h4"
                            size="3xl"
                          >
                      ...
                      <div className="flex flex-col items-center justify-start w-full">
                        <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                          <List
                            className="md:flex-1 sm:flex-col flex-row sm:gap-5 grid sm:grid-cols-1 grid-cols-5 w-[72%] md:w-full"
                            orientation="horizontal"
                          >
                            <div className="border border-indigo_51 border-solid flex flex-col items-center justify-start sm:ml-[0] p-3 w-full">
                              <Text
                                className="!font-semibold mb-[5px] text-bluegray_800"
                                as="h6"
                                size="lg"
                              >
                                Sun 2/1
                          ...
                          <div className="border border-indigo_51 border-solid flex flex-col items-center justify-start p-3">
                            <Text
                              className="!font-semibold mb-[5px] text-bluegray_800"
                              as="h6"
                              size="lg"
                        ...
                        <div
                          className="bg-cover bg-no-repeat flex flex-col h-[598px] items-start justify-start p-4 w-full"
                          style={{
                            backgroundImage: "url('images/img_group2310.svg')",
                          }}
                        >
                          <div className="bg-deep_orange_300 flex flex-row gap-[9px] items-start justify-start mb-[536px] md:ml-[0] ml-[101px] p-1 rounded w-[14%] md:w-full">
                            <div className="flex flex-row gap-2 items-end justify-center mb-1.5 ml-3 w-[71%]">
                              <div className="bg-white_A700 h-2 mt-[7px] rounded-[50%] w-2"></div>
                              <Text className="text-white_A700" size="md">
                                8:10 am
                              </Text>
                            </div>
                            <Text
                              className="!font-semibold mb-1.5 text-white_A700"
                              size="md"
                            >
                              Mêt
                            </Text>
