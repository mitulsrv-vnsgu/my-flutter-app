          ...
          <Sidebar className="!sticky !w-[241px] flex h-screen md:hidden justify-start overflow-auto md:px-5 top-[0]">
            <div className="bg-white_A700 flex flex-col gap-9 items-center justify-start p-[29px] sm:px-5 w-full">
              ...
              <div className="flex flex-col items-start justify-start mb-[422px] w-[87%] md:w-full">
                ...
                <div className="flex flex-row gap-[34px] items-start justify-between md:ml-[0] ml-[3px] mt-8 w-[99%] md:w-full">
                  <div className="flex flex-row gap-4 items-start justify-start mt-0.5">
                    <Img
                      ...
                      alt="Icon Two"
                    />
                    <Text className="mt-1 text-bluegray_400" size="md">
                      Message
                    </Text>
                  </div>
                  <Text
              ...
              <div className="flex flex-col gap-[35px] items-center justify-start mt-[15px] w-full">
                ...
                <div className="bg-white_A700 flex flex-col items-center justify-start p-8 sm:px-5 rounded shadow-bs w-full">
                  <div className="flex flex-col items-center justify-start mb-4 mt-5 w-full">
                    ...
                    <SelectBox
                      className="bg-white_A700 border border-indigo_51 border-solid font-medium mt-6 pl-5 py-[19px] rounded text-base text-bluegray_800 text-left w-[31%] sm:w-full"
                    ...
                    <div className="flex md:flex-col flex-row gap-5 items-center justify-between mt-10 w-full">
                      <div className="border-2 border-dashed border-indigo_51 flex md:flex-1 flex-col items-center justify-start p-[34px] sm:px-5 rounded w-1/2 md:w-full">
                      ...
                      <div className="md:h-[291px] h-[359px] relative w-1/2 md:w-full">
                        <Img
                          src="images/img_image6.png"
                          className="h-[291px] m-auto object-cover rounded-[16px] w-[86%]"
                          alt="imageSix"
                        />
                        <div className="absolute border-2 border-dashed border-indigo_51 h-[359px] md:h-[54px] inset-[0] justify-center m-auto p-16 md:px-10 sm:px-5 rounded w-full">
