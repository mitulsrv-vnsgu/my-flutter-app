          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="bg-gray_51 flex flex-col items-center justify-end p-[23px] sm:px-5 w-full">
              <div className="flex flex-col gap-[35px] items-center justify-start mt-[15px] w-full">
                ...
                <div className="bg-white_A700 flex flex-col md:gap-10 gap-20 items-center justify-start p-[103px] md:px-10 sm:px-5 rounded shadow-bs w-full">
                  <Img
                    src="images/img_group18034.svg"
                    className="h-[215px]"
                    alt="Group18034"
                  />
                  <div className="flex flex-col gap-8 justify-start mb-[130px] w-1/2 md:w-full">
                    <div className="flex flex-col gap-[13px] justify-start w-full">
                      ...
                      <Text
                        className="!font-normal md:ml-[0] ml-[59px] text-bluegray_900"
                        size="md"
                      >
                        Thank for your patient. Your account has been protected
                      </Text>
                    </div>
                    <Button className="bg-deep_orange_300 cursor-pointer font-bold min-w-[207px] md:ml-[0] ml-[143px] mr-[115px] py-[15px] rounded-[24px] text-center text-sm text-white_A700">
                      Explore product
                    </Button>
                  </div>
                </div>
