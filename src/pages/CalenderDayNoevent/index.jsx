              ...
              <div className="flex flex-col gap-[38px] items-start justify-start mt-3.5 w-full">
                ...
                <div className="flex md:flex-col flex-row font-inter gap-5 items-center justify-between w-full">
                  <div className="bg-white_A700 flex md:flex-1 flex-col items-center justify-start p-8 sm:px-5 rounded shadow-bs w-[24%] md:w-full">
                    <div className="flex flex-col items-start justify-start mb-2 w-full">
                      <div className="flex flex-col gap-6 items-center justify-start w-full">
                        ...
                        <Button
                          className="bg-deep_orange_300 cursor-pointer flex items-center justify-center min-w-[209px] pl-[31px] py-[17px] rounded-[24px]"
                          rightIcon={
                            <Img
                              src="images/img_plus.svg"
                              className="ml-[3px] mr-[35px] my-3.5"
                              alt="plus"
                            />
                          }
                        >
                  ...
                  <div className="bg-white_A700 flex md:flex-1 flex-col items-center justify-start p-[26px] sm:px-5 rounded shadow-bs w-3/4 md:w-full">
                    <div className="flex flex-col gap-[30px] items-center justify-start mb-1.5 w-[99%] md:w-full">
                      ...
                      <div className="h-[642px] relative w-full">
                        <Button className="border border-indigo_51 border-solid cursor-pointer font-semibold mb-[-1px] min-w-[794px] md:min-w-full mx-auto py-3 text-base text-bluegray_800 text-center z-[1]">
                          Friday
                        </Button>
                        <div className="border border-indigo_51 border-solid flex flex-col gap-[54px] items-center justify-start mt-auto mx-auto p-[121px] md:px-10 sm:px-5 w-full">
                          <Img
                          ...
                          />
                          <Text
                            className="!font-normal mb-40 text-bluegray_400"
                            size="lg"
                          >
                            <span className="text-bluegray_400 font-inter text-left text-base">
                              No Event.{" "}
                            </span>
                            <span className="text-indigo_400 font-inter text-left text-base font-medium">
                              Create new
                            </span>
                          </Text>
                        </div>
