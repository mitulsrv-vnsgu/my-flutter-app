...
import 'package:mitul_s_application176/widgets/app_bar/appbar_image.dart';
import 'package:mitul_s_application176/widgets/app_bar/appbar_title.dart';
import 'package:mitul_s_application176/widgets/app_bar/custom_app_bar.dart';
              ...
              Expanded(
                child: Align(
                  ...
                  child: Padding(
                    ...
                    child: BlocSelector<InterestsPeopleBloc,
                        InterestsPeopleState, InterestsPeopleModel?>(
                      ...
                      builder: (context, interestsPeopleModelObj) {
                        return ListView.separated(
                          ...
                          itemCount: interestsPeopleModelObj
                                  ?.interests1ItemList.length ??
                              0,
                          itemBuilder: (context, index) {
                            Interests1ItemModel model = interestsPeopleModelObj
                                    ?.interests1ItemList[index] ??
                                Interests1ItemModel();
