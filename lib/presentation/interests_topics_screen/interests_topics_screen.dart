              ...
              Expanded(
                child: Align(
                  ...
                  child: Padding(
                    ...
                    child: BlocSelector<InterestsTopicsBloc,
                        InterestsTopicsState, InterestsTopicsModel?>(
                      ...
                      builder: (context, interestsTopicsModelObj) {
                        return ListView.separated(
                          ...
                          itemCount: interestsTopicsModelObj
                                  ?.interestsItemList.length ??
                              0,
                          itemBuilder: (context, index) {
                            InterestsItemModel model = interestsTopicsModelObj
